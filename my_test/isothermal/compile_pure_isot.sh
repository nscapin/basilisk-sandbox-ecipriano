...
# compile
#
CC99='mpicc -std=c99' qcc -grid=quadtree -events -autolink -progress -O2 -Wall -pipe -D_FORTIFY_SOURCE=2 -D_MPI=1 -o pure_isot/pure_isot pureisothermal.c -L$BASILISK/gl -lfb_tiny -lm
